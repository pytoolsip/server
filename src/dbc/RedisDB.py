...
class RedisDB(object):
	...
	def __init__(self):
		...
		self.__pool = redis.ConnectionPool(host = srvConf.Get("redis", "host"), port = int(srvConf.Get("redis", "port")), password = srvConf.Get("redis", "password"), decode_responses=True);
